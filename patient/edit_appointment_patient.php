...
<html>
    <head>
        ...
        <!--Title-->
        <title>Patient | Edit Appointment</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="dept_name" id="dept_name" class="form-control type="text" value="'.$appointmentData['Dept_Name'].'" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-grid">
                                            ...
                                            <br>
                                            <a href="appointment_patient.php" class="btn btn-soft-primary">CANCEL</a>
                                        </div>
                                    </div>
                                </div>
                            </form>';
