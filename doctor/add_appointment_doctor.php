...
if(isset($_REQUEST['add_appointment'])) {
    ...
    if ($insert_query > 0) {
        $msg = "Appointment data added successfully!";
    } else {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control department-name" name="dept_id" id="dept_id">
                                                    <?php
                                                    $departmentQuery = "SELECT d.`Dept_ID`, d.`Dept_Name` FROM `department` d 
                                                                        INNER JOIN doctor doc ON d.`Dept_ID` = doc.`Dept_ID`
                                                                        WHERE d.`Dept_Status` = 1 AND doc.`Doctor_Name` = '$doctorName'";
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="doctor_name" value="<?php echo $doctorName; ?>" readonly> 
                                            </div>
                                        </div>
