...
<html>
    <head>
        ...
        <!--Title-->
        <title>Doctor | View Doctor</title>
            ...
            <section class="section dashboard">
                <div class="row">
                    ...
                    <div class="col-sm-8 text-right m-b-20">
                        <a href="doctors.php" class="btn btn-primary btn-rounded float-right"><i class="bi bi-arrow-left"></i> Back</a>
                    </div>
                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input name="dob" id="dob" type="date" class="form-control" value="<?php echo $doctorData['Doctor_DOB']; ?>" readonly>
                                                                        </div>                                                                               
                                                                    </div><!--end col-->
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input name="number" id="number" type="text" class="form-control" value="<?php echo $doctorData['Doctor_PhoneNo']; ?>" readonly>
                                                                        </div>                                                                               
                                                                    </div><!--end col-->
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <textarea name="address" id="address" rows="4" class="form-control"  readonly><?php echo $doctorData['Doctor_Address']; ?></textarea>
                                                                        </div>                                                                               
                                                                    </div><!--end col-->
