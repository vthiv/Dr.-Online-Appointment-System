...
<html>
    <head>
        ...
        <!--Title-->
        <title>Admin | Departments List</title>
                            ...
                            <?php    }?>
                                <td>
                                    <form action="edit_department.php" method="POST">
                                        <input type="hidden" name="edit_id" value="<?php echo $row['Dept_ID'] ?>" />
                                        <button type="submit" name="edit_dept_btn" class="btn btn-info"><i class="bi bi-pencil-square"></i></button>
                                    </form>
                                </td>
                            </tr>
                            <?php     }?>
